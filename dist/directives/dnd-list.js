...
var DndList = (function () {
    ...
    DndList.ɵfac = function DndList_Factory(t) { return new (t || DndList)(i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i1.DndState)); };
    DndList.ɵdir = i0.ɵɵdefineDirective({ type: DndList, selectors: [["", "dndList", ""]], hostBindings: function DndList_HostBindings(rf, ctx) { if (rf & 1) {
            i0.ɵɵlistener("dragenter", function DndList_dragenter_HostBindingHandler($event) { return ctx.handleDragEnter($event); })("dragover", function DndList_dragover_HostBindingHandler($event) { return ctx.handleDragOver($event); })("drop", function DndList_drop_HostBindingHandler($event) { return ctx.handleDrop($event); })("dragleave", function DndList_dragleave_HostBindingHandler($event) { return ctx.handleDragLeave($event); });
...
export { DndList };
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DndList, [{
        type: Directive,
        args: [{
                selector: '[dndList]',
            }]
