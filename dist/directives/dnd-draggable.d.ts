...
export declare class DndDraggable implements OnInit, OnDestroy {
    ...
    private optionP;
    get option(): DndDraggableConfig;
    set option(v: DndDraggableConfig | undefined);
    dndType: string;
    dndObject: any;
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<DndDraggable, "[dndDraggable]", never, { "option": "dndDraggable"; "dndType": "dndType"; "dndObject": "dndObject"; "disableDrag": "dndDragDisabled"; }, { "dndDragStart": "dndDragStart"; "dndDragEnd": "dndDragEnd"; "dndCopied": "dndCopied"; "dndLinked": "dndLinked"; "dndMoved": "dndMoved"; "dndCanceled": "dndCanceled"; "dndSelected": "dndSelected"; }, never, never, false, never>;
}
